...
subject * subject_create (int num_of_trials) {
  ...
  new_subject->params = malloc (sizeof(gs_stroop_params));
  ...
  new_subject->params->taskdemand_weights_inhibitory = -2.5; // TEMP CODE!!!
  new_subject->params->taskdemand_weights_excitatory = 2.5;
