...
#imageDirectory <- file.path("/media/ramdisk/simulation_11") # path to save images to
...
data.raw = subset(data.raw, select = c("trialid", "sequence_cond", "sequence", "PATH.block", "PATH.trial", "rsi_n1", "rsi_n", "cue", "stim_0", "stim_1", "stim_2", "response", "cycles", "correct"))
#
