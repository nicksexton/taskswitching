...
# simulation 6d - genetic algorithm for fitting switch costs
# uses only conditions 0SW vs. 1SW to save processing time


import random
import sys, getopt # for parsing cmd line params

filename_conf = "sim_6d_trials.conf"
filename_lookup = "sim_6d_lookup.txt"
