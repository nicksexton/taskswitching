...
filename.output.genetic.results <- "sim_6d_genetic_results_fitsc_allow.txt" # results of GA
write ("Genetic algorithm for Neg conflict: allow neg conflict, fit Switch cost (30)\n\n",
...
test.generation <- function (gen, iteration) {
  ...
  gen$ssqerror <- calculate.fit (results=gen[names(results)],
                                 target.0SW=65.0, target.1SW=95.0)
