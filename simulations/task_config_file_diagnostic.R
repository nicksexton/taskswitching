...
trialconf <- read.delim("sim_4_trials.conf", header=FALSE, sep=c("", ":"), col.names=labels.trialconf) # symmetric
lookup <- read.delim("sim_4_lookup.txt", header=FALSE, sep=c("", ":"), col.names=labels.lookup) # symmetric
