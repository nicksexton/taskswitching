...
filename.output.genetic.results <- "sim_13_modelv1_gridsearch_8x8pt2.txt" # where to store results
...
model.conf.leaf.min <- c(conflict.gain = 0.0, conflict.tdwt = -15.0, conflict.bias = -42.0)
model.conf.leaf.max <- c(conflict.gain = 98.0, conflict.tdwt = -8.0, conflict.bias = 0.0)

path.ramdiskfolder <- "sim13_8x8v2"
