...
# Noise .006 c/w .004 in previous gridsearch
...
filename.output.genetic.results <- "sim_6e_gridsearch_results_highnoise_rescale.txt" # where to store results
...
path.ramdiskfolder <- "6e_errors_rescale_0"
